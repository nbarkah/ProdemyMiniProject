...
<link href="<c:url value="/resources/theme1/css/logreg.css" />" rel="stylesheet">
<title>Login</title>
</head>
<body>
	<div class="container">
			...
			<div class="form login">
				...
				<f:form action="login" modelAttribute="person" method="post">
					...
					<div class="input-field button">
                        <input style="color: #0e1212;" type="submit" value="Masuk">
                    </div>
				</f:form>

				<div class="login-signup">
					<span class="text">Bukan member? 
					<a class="text signup-link" href='<c:url value="/register"></c:url>' style="color:rgb(254, 187, 211);">Buat Sekarang</a>
					</span>
				</div>
			</div>
		</div>
